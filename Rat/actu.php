...
$articles = $bdd->query('SELECT * FROM articles where Categorie = "Economie" ');
...
<body>
    ...
    <div id="block-heading">
        <h1 class="text-center" style="color: black ; padding-right: 1385px">Actu</h1>
                    <h2 class="text-bnb" id="text-bnb">Qu’il s’agisse de téléphonie, de transports ou, d’idées cadeaux, Réponse à tout suit pour vous l’actualité de la conso. Toutes les infos sur le coût de la vie et la façon de faire des économies.<br><br><br></h2>
                </div>

...
if(!empty($_POST)){
    ...
    $req = $DB->query('Select mail from users where mail = :mail', array('mail' => $Mail));
    $req = $req->fetch();
    ...
    if($valid){
        ...
        $id_public = uniqid();
                    $DB->insert('insert into users (mail, password, gendre, idpublic) values (:mail, :password, :gendre, :idpublic)', array('mail' => $Mail, 'password' => crypt($Password, '$2a$10$1qAz2wSx3eDc4rFv5tGb5t'), 'gendre' => $selected_gendre, 'idpublic' => $id_public));
    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form method="post" action="inscription.php">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">s'inscrir</button></div><a href="connexion.php" class="already">avez-vous déja un compte? connectez-vous ici.</a></form>
        </div>
    </div>
